...
class TestClient(unittest.TestCase):
    ...
    @patch("tap_customerio.client.session")
    ...
    @parameterized.expand([
        ["400 error", 400, MockResponse(400), customerioBadRequestError, "A validation exception has occurred."],
        ["401 error", 401, MockResponse(401), customerioUnauthorizedError, "The access token provided is expired, revoked, malformed or invalid for other reasons."],
    ...
    @parameterized.expand([
        ...
        ["502 error", 502, MockResponse(502), customerioBadGatewayError, "Server received an invalid response."],
        ["503 error", 503, MockResponse(503), customerioServiceUnavailableError, "API service is currently unavailable."],
    ])
    @patch("time.sleep")
